    ...
    <div className="home-container">
      <div className="hero-section">
        ...
        <p>
          ...
          ctos. Añade, edita, visualiza y elimina productos de forma sencilla y
          eficien te.
        </p>
      ...
      <div className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Realiza todas las operaciones CRUD (Crear, Leer, Actualizar,
              Elimin ar) sobre tu inventario de productos.
            </p>
          </div>
          <div className="feature-card">
          ...
          <div className="feature-card">
            ...
            <p>
              ...
              blico del backend y base de datos en subredes privadas.
            </p>
          </div>
        </div>
      </div>
